...
const ProductDetailScreen = ({navigation, route}) => {
  ...
  const getProductInfo = () => {
    AsyncStorage.getItem('userExist').then(res => {
      axios
        .get(
          `http://Ictkart.com/api/product/detail?productId=${
  ...
  const getsProductInfo = id => {
    AsyncStorage.getItem('userExist').then(res => {
      axios
        .get(
          `http://Ictkart.com/api/product/detail?productId=${id}&userId=${JSON.parse(
            res,
          )}`,
        )
        .then(response => {
  ...
  const renderItem_sider1 = ({item, index}) => {
    return (
      <View key={index}>
        <Image
          style={{height: height * 0.4, width: width, borderRadius: 6}}
  ...
  const renderItem_trending = ({item, index}) => {
    ...
    return (
      <View
        ...
        <TouchableOpacity
          onPress={() => {
            getsProductInfo(item._id);
            getsRecProductInfo(item._id);
              ...
              <View
                ...
                <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => alert('Check your locations')}>
                      <View style={{paddingTop: width * 0.01}}>
                        <Text
                          style={{color: '#1776BB', fontSize: width * 0.04}}>
                ...
                <>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {sdata.shop == null ? 'NA' : sdata.shop.companyName}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text
                      ...
                      {sdata.shop == null ? 'NA' : sdata.shop.slogan}
                    </Text>
                  </View>
                  {sdata.shop == null ? null : (
                    <TouchableOpacity
        ...
        <ScrollView
          ...
          <TouchableOpacity
            ...
            <Text
              ...
              {sdata.shop == null ? 'NA' : sdata.companyName}
            </Text>
          </TouchableOpacity>
          <View
            style={{
