...
export default class index extends Component {
  ...
  getBanner() {
    try {
      axios
        .get('http://Ictkart.com/api/banner/list?displayAt=service&status=true')
        .then(response => {
  ...
  getCategories() {
    try {
      axios
        .get('http://Ictkart.com/api/categories/dropdown/list?type=service')
        .then(response => {
...
<Text style={{fontSize:width*0.05,fontWeight:'bold',}}>
  Computer Hardware
              ...
              <View style={{paddingBottom: width * 0.08}}></View>
            </ScrollView>
          </View>
        </ScrollView>
      </View>
