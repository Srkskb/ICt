...
const Myordersscreen = ({navigation, route}) => {
  ...
  const getlist = () => {
    ...
    AsyncStorage.getItem('userExist').then(res => {
      ...
      var config = {
        method: 'post',
        url: 'http://Ictkart.com/api/buyproduct/list',
        headers: {
  ...
  const getDetails = id => {
    var config = {
      method: 'get',
      url: `http://Ictkart.com/api/buyproduct/order-details/${id}`,
      headers: {
        'Content-Type': 'application/json',
      },
      // data : data
  ...
  const actualDownload = id => {
    ...
    RNFetchBlob.config({
      ...
      .fetch('GET', `http://Ictkart.com/api/invoice/download/${id}`, {})
      .then(res => {
        ...
        <TouchableOpacity onPress={() => getDetails(item.id)}>
          ...
          <View
            ...
            <View style={{alignItems: 'flex-end', justifyContent: 'center'}}>
              <Text style={{color: 'black', fontSize: 13}}>Ordered At</Text>
              <Text style={{color: 'black', fontWeight: 'bold'}}>
                {getParsedDate(item.createdAt)}
              </Text>
            </View>
          </View>
          <View
            ...
            <View style={{flex: 1, justifyContent: 'flex-end'}}>
              <Text style={{color: 'black', fontSize: 13}}>Current Status</Text>
              <Text
                style={{
                  color: DefaultColours.black,
                  fontSize: 15,
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => Toast.show('Order Cancelled')}
              style={{
                borderColor: '#5A429B',
                height: 40,
                borderRadius: 4,
        ...
        <View style={styles.container}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View
              ...
              <View
                style={{width: '100%', borderBottomWidth: 1, marginBottom: 4}}>
                <Text
                  style={{
                    color: DefaultColours.black,
                    fontSize: FontSize(16),
              ...
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%'}}>
                  <Text
                    ...
                    AED {data.products.originalPrice}
                  </Text>
                </View>
              </View>
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%'}}>
                  <Text
                    ...
                    AED {data.products.sellingPrice}
                  </Text>
                </View>
              </View>
            </View>
              ...
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%'}}>
                  <Text
                    ...
                    {data.buyproducts.transactionId}
                  </Text>
                </View>
              </View>
              <View style={{width: '100%', flexDirection: 'row'}}>
              ...
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%'}}>
                  <Text
                    ...
                    AED {data.buyproducts.totalPrice}
                  </Text>
                </View>
              </View>
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%'}}>
                  <Text
                    ...
                    AED {data.buyproducts.paidAmount}
                  </Text>
                </View>
              </View>
              <View style={{width: '100%', flexDirection: 'row'}}>
              ...
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%', padding: 5}}>
                  <Text
                    ...
                    {data.user.address.postalAddress},{data.user.address.city},
              ...
              <View style={{width: '100%', flexDirection: 'row'}}>
                ...
                <View style={{width: '70%', padding: 5}}>
                  <Text
                    ...
                    {data.vendor?.address.postalAddress},
                    {data.vendor?.address.city},{data.vendor?.address.state},
