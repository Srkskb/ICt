...
const HomeScreen = ({navigation, route}) => {
  ...
  const [professionalservicesData, setprofessionalservicesData] = useState([
    {
      id: 1,
      image: '@images/images/sample1.png',
      badge: true,
      name: 'Denis Thompson',
    ...
    {
      id: 2,
      image: '@images/images/sample2.png',
      badge: false,
      name: 'Craing William',
      description: 'Laptop Repair Services',
      price1: '650',
      price2: '750',
      rating: '4.9',
    },
  ...
  const category = () => {
    try {
      axios
        .get('http://Ictkart.com/api/categories/dropdown/list?type=product')
        .then(response => {
  ...
  const getBrands = () => {
    try {
      axios
        .get('http://Ictkart.com/api/brand/dropdown/list')
        .then(response => {
  ...
  const getlist = () => {
    try {
      axios
        .post('http://Ictkart.com/api/product/all/list')
        .then(response => {
  ...
  const getFeatured = () => {
    try {
      axios
        .post('http://Ictkart.com/api/product/all/features-list')
        .then(response => {
          //console.log('response list',response.data.data.list)
  ...
  const getBanner = () => {
    try {
      axios
        .get('http://Ictkart.com/api/banner/list?displayAt=home&status=true')
        .then(response => {
  ...
  const renderItem_sider1 = ({item, index}) => {
    return (
      <View key={item._id}>
        <Image
          style={{height: 180, width: SCREEN_WIDTH - 24, borderRadius: 6}}
          ...
          <View
            ...
            <View style={{flex: 1, justifyContent: 'flex-end'}}>
              <Text style={{color: DefaultColours.black, fontSize: 15}}>
                {item.currency}{' '}
                <Text style={{fontWeight: 'bold'}}>{item.sellingPrice}</Text>
              </Text>
              <Text
                style={{
                  color: 'grey',
            ...
            <View
              ...
              <Image
                source={require('@images/images/star.png')}
    ...
    return (
      <View
        ...
        <View style={{alignItems: 'center', padding: 10}}>
          {index % 2 == 0 ? (
            <Image
              source={require('@images/images/s1.png')}
              style={{borderRadius: 50, width: 100, height: 100}}
            />
          ) : (
            <Image
              source={require('@images/images/s2.png')}
              style={{borderRadius: 50, width: 100, height: 100}}
            />
          )}
        </View>
        <View
          ...
          {item.badge && (
            <Image
              source={require('@images/images/service_badge.png')}
              style={{width: 20, height: 20}}
            />
          )}
        </View>
        ...
        <View
          ...
          <View
            ...
            <Image
              source={require('@images/images/pinkstar.png')}
              style={{width: 20, height: 20}}
            />
            <Text style={{color: DefaultColours.black, fontSize: 15}}>
              {item.rating}
          ...
          <View style={{flex: 1, justifyContent: 'flex-end'}}>
            ...
            <Text style={{color: DefaultColours.black, fontSize: 15}}>
              AED <Text style={{fontWeight: 'bold'}}>{item.price1}</Text>
            </Text>
          </View>
        </View>
      </View>
  ...
  const searchItem = (item, text) => {
    ...
    if (item != '') {
      ...
      var config = {
        method: 'post',
        url: 'http://Ictkart.com/api/product/all/list',
        headers: {
          'Content-Type': 'application/json',
        },
        data: data,
  ...
  return (
    <>
            ...
            <ScrollView contentContainerStyle={{width: SCREEN_WIDTH}}>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Text style={{color: DefaultColours.black}}>
                    Click to reveal address modal
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={{
                  ...
                  <View
                    ...
                    <Text style={{color: DefaultColours.white, fontSize: 9}}>
                      10
                    </Text>
                  </View>
                  <Svg
                ...
                <TouchableOpacity
                  onPress={() => setState(prev => ({...prev, search: true}))}
                  style={{
                    width: '10%',
                    alignItems: 'center',
                    justifyContent: 'center',
              ...
              <View
                ...
                <Image
                  source={require('@images/images/fire.png')}
              ...
              <View
                ...
                <Image
                  source={require('@images/images/toppicks.png')}
                  style={{width: 20, height: 20}}
                />
                <Text
                  style={{
              ...
              <View
                ...
                <Image
                  source={require('@images/images/professional_services.png')}
                  style={{width: 20, height: 30}}
                />
                <Text
                  style={{
      ...
      <Modal
        ...
        <View
          ...
          <View
            ...
            <Text style={{color: 'black', fontSize: 18, padding: 26}}>
              Hide this modal by pressing backbutton
            </Text>
          </View>
          {/*
                <TouchableOpacity
      ...
      <Modal
        ...
        onRequestClose={() => setState(prev => ({...prev, search: false}))}>
        <View
          style={{
            width: '100%',
            height: SCREEN_HIGHT,
          ...
          <View
            ...
            <View
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity
                  onPress={() => searchItem(searchText, 'new')}
                  style={{
                    paddingHorizontal: 10,
                ...
                <TouchableOpacity
                  onPress={() => searchItem(searchText, 'high')}
                  style={{
                    paddingHorizontal: 10,
                    alignItems: 'flex-start',
                    justifyContent: 'center',
                ...
                <TouchableOpacity
                  onPress={() => searchItem(searchText, 'low')}
                  style={{
                    paddingHorizontal: 10,
                    alignItems: 'flex-start',
                    justifyContent: 'center',
              ...
              {mview == 'filter' && (
                <View
                  ...
                  <View
                    ...
                    <View
                      style={{width: '100%', flexDirection: 'row', height: 44}}>
                      <View
                        style={{
                          width: '20%',
                          justifyContent: 'center',
                        ...
                        <ScrollView
                          ...
                          {brand.map((item, index) => {
                            return (
                              <TouchableOpacity
                                key={index}
                                onPress={() => setBrandArr(item.value)}
                                style={{
                                  paddingHorizontal: 10,
                                  alignItems: 'flex-start',
                                  justifyContent: 'center',
                                  ...
                                  borderRadius: 10,
                                  marginRight: 6,
                                  borderColor: brandarr.includes(item.value)
                                    ? DefaultColours.blue0
                                    : DefaultColours.black,
                                  height: 40,
                                }}>
                                <Text
                                  style={{
                                    color: brandarr.includes(item.value)
                                      ? DefaultColours.blue0
                                      : DefaultColours.black,
                                    fontWeight: '400',
                                    fontSize: 16,
                        ...
                        <ScrollView
                          ...
                          {subCategories.map((item, index) => {
                            return (
                              <TouchableOpacity
                                key={index}
                                onPress={() => setCategArr(item.value)}
                                style={{
                                  paddingHorizontal: 10,
                                  alignItems: 'flex-start',
                                  justifyContent: 'center',
                                  ...
                                  borderRadius: 10,
                                  marginRight: 6,
                                  borderColor: categoryarr.includes(item.value)
                                    ? DefaultColours.blue0
                                    : DefaultColours.black,
                                  height: 40,
                                }}>
                                <Text
                                  style={{
                                    color: categoryarr.includes(item.value)
                                      ? DefaultColours.blue0
                                      : DefaultColours.black,
                                    fontWeight: '400',
                                    fontSize: 16,
