...
const getlist = () => {
  ...
  return (
    ...
    paddingVertical:6,width: '100%',height: '100%' }}>
    {/*<StripeProvider>*/}
    <CardField
    ...
    />
    {/*</StripeProvider>*/}
    <TouchableOpacity onPress={()=>openPaymentSheet()} style={{backgroundColor: '#5A429B',
    height:44,borderRadius:4,justifyContent:'center',alignItems:'center',marginTop:'1%',
    width:'100%'}}>
