...
const DrawerContent = ({navigation}) => {
  ...
  const  loginCheck = async () => {
   ...
   var response = await axios.get(`http://Ictkart.com/api/user/detail?userId=${currentUserData}`)
   ...
   if(typeof response.data !== 'undefined' && response.data !== null ){
    ...
    const category=()=>{
      try {
     axios.get('http://Ictkart.com/api/categories/dropdown/list?type=product')
      .then(response => {
